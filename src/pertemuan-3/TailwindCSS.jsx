...
function Spacing(){
  return (
      <div className="bg-white shadow-lg p-6 m-4 rounded-lg">
          ...
          <p className="mt-2 text-gray-600">Ini adalah contoh penggunaan 
            padding dan margin di Tailwind.</p>
      </div>
  )
}
...
function Typography(){
  return (
      <div>
          ...
          <p className="text-gray-600 text-lg mt-2">Belajar Tailwind sangat 
                                                    menyenangkan dan cepat!</p>
      </div>
  )
}
