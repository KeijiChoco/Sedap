    ...
    return (
        <div id="Sidebar" className="flex min-h-screen w-90 flex-col bg-white p-10 shadow-lg">
            ...
            <div id="Sidebar-logo" className="flex flex-col">
                <span id="logo-title" className="font-poppins text-[48px] text-gray-900">DeCafe <b id="logo-dot" className="text-hijau">.</b></span>
                <span id="logo-subtitle" className="font-semibold text-gray-400">DeCafe Dashboard</span>
            </div>
